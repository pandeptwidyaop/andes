    ...
    @section('content')
        ...
        <section class="forms">
            <div class="container-fluid">
                <div class="row">
                    @component('layouts.components.card',['class' => 'col-md-12','title' => 'Data Pengeluaran'])
                      <button type="button" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Pengeluaran</button><br><br>
                        <table class="table table-bordered" id="table">
                            <thead>
                                <tr>
                                    <th><center>Gambar</center></th>
                                    <th><center>Nama Pengeluaran</center></th>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                     <h4 class="modal-title" id="">Edit Data Pengeluaran</h4>
