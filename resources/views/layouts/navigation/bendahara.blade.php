...
<ul class="list-unstyled">
          ...
          <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Kas </a>
            <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
              <li><a href="{{asset('bendahara/kas')}}">Data Kas</a></li>
              <li><a href="{{asset('bendahara/tambah-kas')}}">Tambah Kas</a></li>
            </ul>
          </li>
          <li><a href="#exampledropdownDropdown1" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Pemasukan </a>
