@extends('layouts.app',['_nav' => 'sekretaris','_nav_active' => 'received-letter'])
    @section('content')
            ...
            <div class="container-fluid">
                <div class="row">
                    @component('layouts.components.card',['class' => 'col-md-12','title' => 'Data Surat Masuk'])
                      <button type="button" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Surat Masuk</button></br></br>
