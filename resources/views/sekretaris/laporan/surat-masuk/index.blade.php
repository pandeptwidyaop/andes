        ...
        <div class="container-fluid">
            <div class="row">
                @component('layouts.components.card',['class' => 'col-md-12','title' => 'Data Surat Masuk'])
                  <button type="button" name="button" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Laporan Surat Masuk</button>
                  <br><br>
                        ...
                        <tbody>
                            @foreach (config('master.in_letters') as $key => $value)
                                <tr>
                                    ...
                                    <td><a href="{{url('ketua/surat/masuk/lihat')}}" data-toggle="modal" data-target="#modalSurat">Detail</a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
