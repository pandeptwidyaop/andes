@extends('layouts.app',['_nav' => 'sekretaris', '_nav_active' => 'profile'])
@section('content')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="" placeholder="" value="{{config("master.users.sekretaris.name")}}">
                          </div>
                          <div class="form-group">
                            <label for="">Username</label>
                            <input type="text" class="form-control" id="" placeholder="" value="{{config("master.users.sekretaris.username")}}">
                          </div>
                            <div class="form-group">
                              <label for="">Email</label>
                              <input type="email" class="form-control" id="" placeholder="" value="{{config("master.users.sekretaris.email")}}">
                            </div>
                            <div class="form-group">
                              <label for="">Tanggal Lahir</label>
                              <input type="text" class="form-control" id="" placeholder="" value="{{config("master.users.sekretaris.birthday")}}">
                            </div>
                            <div class="form-group">
                              <label for="">Handphone</label>
                              <input type="text" class="form-control" id="" placeholder="" value="{{config("master.users.sekretaris.phone")}}">
                            </div>
                            <div class="form-group">
                              <label for="">Alamat</label>
                              <textarea name="name" rows="8" cols="80" class="form-control">{{config("master.users.sekretaris.address")}}</textarea>
                            </div>
                            <br>
                        ...
                        <div class="col-md-6 text-center">
                            <div class="avatar">
                                <img src="{{asset("img/".config("master.users.sekretaris.avatar"))}}" alt="..." class="img-fluid rounded-circle">
                            </div>
                            <br>
